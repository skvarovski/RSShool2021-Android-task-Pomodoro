...
class CircleCustomView @JvmOverloads constructor(
    ...
    init {
        if (attrs != null) {
            ...
            color = styledAttrs.getColor(R.styleable.CircleCustomView_custom_color, Color.RED)
            style = styledAttrs.getInt(R.styleable.CircleCustomView_custom_style, FILL)
            styledAttrs.recycle()
        }
